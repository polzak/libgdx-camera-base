package net.polzak.dodger.util;
...
//        log.debug("world width: " + worldWidth);
//        log.debug("world height: " + worldHeight);
...
//        renderer.line(0, 5, 3, 5);
//        renderer.line(3, 0, 3, 5);
...
//        log.debug("viewport screen width: " + screenWidth);
//        log.debug("viewport screen height: " + screenHeight);
//        log.debug("viewport world width: " + worldWidth);
//        log.debug("viewport world height: " + worldHeight);
//
